...
/**
 * A datatable with a lot of complex functionality (virtual dom, column groups, frozen groups etc)
 * Built for Inventory Overview, but it's used in most other places as well (movement details, statement, valuation etc)
 *
 * @example
 *
 * <sto-complex-datatable [rows]="rows" [columns]="cols"></sto-complex-datatable>
 */
@Component({
