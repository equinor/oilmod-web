 ...
 */
var MdExpansionPanel = MdExpansionPanel_1 = (function (_super) {
...
__decorate([
    core_1.Input()
], MdExpansionPanel.prototype, "hideToggle", void 0);
MdExpansionPanel = MdExpansionPanel_1 = __decorate([
    core_1.Component({
        moduleId: module.id,
        styleUrls: ['sto-filter-panel.component'],
        ...
        providers: [
            { provide: accordion_item_1.AccordionItem, useExisting: core_1.forwardRef(function () { return MdExpansionPanel_1; }) }
        ],
        animations: [
...
MdExpansionPanelActionRow = __decorate([
    core_1.Directive({
